...
lvim.builtin.which_key.mappings["f"] = {
    ...
    c = { "<md>Telescope colorscheme<cr>", "Colorscheme" },
...
lvim.builtin.which_key.mappings["t"] = {
    name = "Terminal",
    n = { "<cmd>lua require('toggleterm')._NODE_TOGGLE()<cr>", "Node" },
    u = { "<cmd>lua require('toggleterm')._NCDU_TOGGLE()<cr>", "NCDU" },
    t = { "<cmd>lua require('toggleterm')._HTOP_TOGGLE()<cr>", "Htop" },
...
--    name = "executor",
--    m = { "<cmd>lua require('executor').executor()<cr>", "executes the current file" },
--    t = { "<cmd>lua require('executor').term_closer()<cr>", "close all terminal windows" },
--}
